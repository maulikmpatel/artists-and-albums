...
public class ArtistsPopulator implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Song heartz = songRepo.save(new Song("Heartz of Men","4:43","stuff", "great", eyez));
		Song dou = songRepo.save(new Song("How Do U Want It","4:48","more stuff", "great", eyez));
		Song holla = songRepo.save(new Song("Holla","4:34","extra stuff","good", genesis));
		Song hurt = songRepo.save(new Song("Make it Hurt", "3:23","lotta stuff", "good", genesis));
